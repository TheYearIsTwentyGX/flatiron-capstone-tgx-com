...
AccessProfile.create!(id: 1, Friendly_Name: "Admin", Department: "Administration", Title: "Administrator", IsAdmin: true)
AccessProfile.create!(id: 2, Friendly_Name: "DON", Department: "Administration", Title: "Director of Nursing", IsAdmin: false)